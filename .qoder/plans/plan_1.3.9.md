...
| T-03   | 代码生成 | T-01      | [∥]  | ≤200       | colony/**init**.py 971→≤500 拆分                                           |
| T-04   | 代码生成 | T-01      | [∥]  | ≤200       | defaults 大文件拆分 (organs/brain 804 + renovated/brain 903 + presets 530) |
| T-05   | 代码生成 | T-01      | [∥]  | ≤200       | biology 大文件拆分 (cat_self 712 + **init** 597)                           |
...
```
T-01 [x] → T-02 [x] → T-03 [x] T-04 [x] T-05 [x] T-06 [x] T-07 [x] [∥] 并行 → T-08 [x] → T-09 [x] → T-10 [ ]
                                                                        └─ release: v1.3.9
```
