...
"""meowcat organ adapters — plug external agents into organ sockets.

v1.2.14: Each organ Protocol is a socket; any external agent can be the plug.
``AgentOrgan`` base class provides delegation, error wrapping,
