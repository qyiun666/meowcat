...
class HippocampusProtocol(Protocol):
    ...
    **Implementor**: Application layer (brain-area organ)
    ...
    # v2.0: KnowledgeTree — tree-structured entity knowledge
    ...
    def search_tree(self, entity_id: str, keyword: str,
                    limit: int = 5) -> list[TreeNode]: ...
    def query_subtree(self, entity_id: str, node_id: str,
                      max_depth: int = 2) -> list[TreeNode]: ...
...
class HypothalamusProtocol(Protocol):
    ...
    **Implementor**: Application layer (brain-area organ)
    ...
    def decay_memories(self, now: float | None = None) -> dict[str, Any]: ...
