...
Usage::
    ...
    # Trigger strategies (v2.0: FusionCycle methods moved to PinealGland)
    gland.trigger()                               # immediate
    gland.trigger_if(PinealGland.on_full(50))     # only when full
    gland.trigger_if(PinealGland.on_event("conversation_end"))
"""
...
class PinealGland(Pluggable):
    ...
    # -- Fusion trigger strategies (v2.0: absorbed from FusionCycle) ----
